...
$("<div class=\"datagrid-mask-msg\"></div>").html("<p style=\"color:#FF0000\" ><font size=\"5\"> Please wait, the data is being calculated...</font></p>").appendTo("div#wait").css({display:"block", 
...
function getresult1(A){
	...
	var t=A.callback;
		$.ajax({ 
		    type: "POST", 	
			url: "http://150.158.131.230/laups/GetParameter.do",
			dataType:"json",
